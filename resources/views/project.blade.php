            ...
            <div class="card-container container mt-3 flex flex-wrap gap-4 justify-start">
                ...
                <div
                    ...
                    <div class="card-footer flex justify-between gap-4">
                        ...
                        <div class="action flex gap-2 self-end">
                            <button
                                onclick="location.href='{{ route('tasks.edit', $task) }}'"
                                type="button"
                                class="capitalize border border-yellow-600 flex items-center text-black bg-yellow-400 hover:bg-yellow-500 focus:outline-none focus:ring-yellow-300 font-medium rounded-lg text-sm py-2 px-4 text-center dark:focus:ring-yellow-900">
                                {{-- svg icon edit --}}
                                <svg
                                    class="w-6 h-6"
                                    aria-hidden="true"
