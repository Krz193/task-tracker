<x-app-layout>
    <div class="container flex flex-col items-center">
        ...
        <form action="{{ isset($project) ? route('project.update', $project) : route('project.store') }}" method="POST" class="flex flex-col w-[70%]">
            @csrf
            @if(isset($project))
                @method('PUT')
            @endif
            ...
            <div class="mb-4">
                ...
                <input type="text" id="project_name" name="project_name" 
                    value="{{ isset($project) ? $project->project_name : old('project_name') }}" required
            ...
            <div class="mb-4">
                ...
                <input type="text" id="description" name="description"
                    value="{{ isset($project) ? $project->description : old('description') }}" required
                    class="mt-1 block w-full rounded-lg border-gray-300 shadow-sm focus:ring-indigo-500 focus:border-indigo-500">
            </div>
